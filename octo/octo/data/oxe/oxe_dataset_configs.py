...
Also contains configuration for pre-computed OXE embedding datasets (at the bottom).
"""
...
##############################################################################
# Configuration for pre-computed OXE embedding datasets.
##############################################################################

# These configs describe the structure of embedding datasets generated by
# Octo_embedding_save.py. Unlike the original OXE configs, embedding datasets
# contain pre-computed Octo embeddings instead of raw images.


OXE_EMBEDDING_CONFIGS: Dict[str, dict] = {
    "bridge_dataset_embedding": {
        "embedding_obs_key": "embedding",
        "embedding_dim": 512,
        "action_dim": 7,
        "language_embedding_dim": 768,
        "original_dataset": "bridge_dataset",
    },
    "fractal20220817_data_embedding": {
        ...
        "action_dim": 7,
        "language_embedding_dim": 768,
        "original_dataset": "fractal20220817_data",
    },
    "bridge_fractal_embedding": {
        "embedding_obs_key": "embedding",
        "embedding_dim": 512,
        "action_dim": 7,
        "language_embedding_dim": 768,
        "original_dataset": "bridge_fractal",
    },
}
...
# Transform functions for each embedding dataset (all use pass-through)
OXE_EMBEDDING_TRANSFORMS: Dict[str, Callable] = {
    "bridge_dataset_embedding": embedding_dataset_transform,
    "fractal20220817_data_embedding": embedding_dataset_transform,
    "bridge_fractal_embedding": embedding_dataset_transform,
}
